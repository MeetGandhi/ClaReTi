...
os.mkdir("saliency_ticked_plots_viridify\\")

for cls in classes:
    
    os.mkdir("saliency_ticked_plots_viridify\\"+cls+"\\")
    blank = glob.glob(cls+"\\saliency"+"\\*.png")
    ...
    for r in random_blank:
        ...
        img_arr_random_dmdt = plt.imread(cls+"\\sub\\"+str(random_id)+".png")
        ...
        im1 = ax1.imshow(img_arr_random_dmdt, origin='upper', cmap=plt.cm.bone)
        ...
        plt.savefig("saliency_ticked_plots_viridify\\"+cls+"\\"+str(random_id)+"_"+str(round(prob[random_id, pd[cls]],4))+".png")
        plt.close()
