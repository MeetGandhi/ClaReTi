...
os.mkdir("grad_CAM_ticked_plots_viridify\\")

for cls in classes:
    
    os.mkdir("grad_CAM_ticked_plots_viridify\\"+cls+"\\")
    blank = glob.glob(cls+"\\grad_CAM"+"\\*.png")
    ...
    for r in random_blank:
        ...
        plt.savefig("grad_CAM_ticked_plots_viridify\\"+cls+"\\"+str(random_id)+"_"+str(round(prob[random_id, pd[cls]],4))+".png")
        plt.close()
