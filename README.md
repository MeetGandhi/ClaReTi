...
![alt text](https://github.com/MeetGandhi/Post-hoc-Explainability-of-Deep-Learning-Models-using-Conditional-Adversarial-Networks/blob/master/braXAI/activation_maximization/fc_out/real_SCI_filter.png "Real Class filter for SCI in fc_out layer")
