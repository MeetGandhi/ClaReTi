...
os.mkdir("shap_ticked_plots_sqrt\\")

for cls in classes:
    
    os.mkdir("shap_ticked_plots_sqrt\\"+cls+"\\")
    blank = glob.glob(cls+"\\*.png")
    ...
    for r in random_blank:
        ...
        plt.savefig("shap_ticked_plots_sqrt\\"+cls+"\\"+str(random_id)+"_"+str(round(prob[random_id, pd[cls]],4))+".png")
        plt.close()
